 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const he=a=>Array.from(a.attributes).reduce((e,s)=>(e[s.name]=s.value,e),{}),X=a=>typeof a=="string"?a:!a||!a.class?"":a.class&&typeof a.class=="string"?a.class.split(" "):a.class&&Array.isArray(a.class)?a.class:"",Y=(a,{nameAttr:e,icons:s,attrs:i})=>{var E;const r=a.getAttribute(e);if(r==null)return;const n=ce(r),d=s[n];if(!d)return console.warn(`${a.outerHTML} icon name was not found in the provided icons object.`);const h=he(a),u=de(h)?{}:{"aria-hidden":"true"},p={...ee,"data-lucide":r,...u,...i,...h},f=X(h),R=X(i),A=oe("lucide",`lucide-${r}`,...f,...R);A&&Object.assign(p,{class:A});const $=ie(d,p);return(E=a.parentNode)==null?void 0:E.replaceChild($,a)};/**
 * @license lucide v1.16.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
        ...
        ${K.map(e=>`
          <div class="bg-slate-900 border border-slate-800 rounded-3xl p-6 hover:border-indigo-500/50 transition-all cursor-pointer" 
            ...
            <div class="flex justify-between items-start mb-4">
              ...
              <span class="text-emerald-400 font-bold text-xs">${q(e.price||e.fee)}</span>
            </div>
            <div class="grid grid-cols-2 gap-4">
               <div>
                 <span class="block text-[8px] font-bold text-slate-500 uppercase mb-1">SPEED</span>
  ...
  `}function We(){const a=window.state.mares.find(s=>s.id===window.state.selectedMareId),e=K.find(s=>s.id===window.state.selectedStallionId);return`
    <div class="min-h-screen bg-slate-950 text-white flex flex-col items-center justify-center p-6">
      <div class="max-w-xl w-full bg-slate-900 border border-slate-800 rounded-[3rem] p-12 text-center space-y-8">
        ...
        <div class="text-2xl font-black text-emerald-400">FEES: ${q(e.price||e.fee)}</div>
